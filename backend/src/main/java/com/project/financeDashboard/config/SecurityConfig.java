...
// // ✅ Make sure JwtAuthFilter is correctly imported
...
//                         .authorizationEndpoint(a -> a.baseUri("/api/auth/oauth"))
//                         .redirectionEndpoint(r -> r.baseUri("/api/auth/oauth/google"))
//                         .userInfoEndpoint(userInfo -> userInfo.userService(customOAuth2UserService))
//                         .successHandler(googleOAuth2SuccessHandler)); // ← CLOSE OAUTH2 LOGIN PROPERLY
